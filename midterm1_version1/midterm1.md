...
```
- Sooty Shearwater, aka, Puffinus griseus has the smallest winter range
...
- Ducks that migrate longer distances tend to have lower average body mass as compared to other migratory strategies. Birds that are residents have the highest average body mass.
...
- As seen below there are species that do not have any data for population size in the data frame. As a result, using solely population size, their conservation status cannot be determined and require additional information to make that classification.
...
- The questions explorede below is Which bird family has the highest average body mass. As shown below, the corresponding bird family is Meleagrididae.
