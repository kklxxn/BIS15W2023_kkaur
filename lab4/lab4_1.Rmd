...
```{r}
mammals_new <- rename(mammals, genus="Genus", afr="AFR",max_life="max. life", litters_year="litters/year", wean_mass="wean mass", litter_size="litter size")
```
