...
```
## here() starts at C:/Users/khush/Desktop/BIS15W2023_kkaur
```
...
- yes, the data is tidy as each variable has its own column, each observation has its own row and each value has its own cell
