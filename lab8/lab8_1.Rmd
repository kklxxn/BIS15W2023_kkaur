...
```{r}
heartrate %>% 
  pivot_longer(-patient, # does not pivot patient
...
- column names other than religion are all variables of same type
...
qpcr_untidy %>% 
  pivot_longer(
    ...
    names_sep="_", #pull apart and specify separator
