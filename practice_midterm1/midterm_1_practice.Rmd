...
- extraction of knowledge of unstrcuture data -> tidy verse, janitor names, group by etc

2. (2 points) What is the most helpful or interesting thing you have learned so far in BIS 15L? What is something that you think needs more work or practice?  
- The most interesting thing so far has been the group by and summarie functions
...
```{r}
elephants <- janitor::clean_names(elephants)s)
glimpse(elephants)
```
```{r}
