...
```{r}
sum(venom_GT,chiron,veyron)/3 #alternatively write num out
```
...
NA values cannot be included in calculations

4. Recalculate the mean using the following code chunk. Why is the useful? -> removes NonApp vals 
```{r}
