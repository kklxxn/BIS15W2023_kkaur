...
homerange %>% 
  ...
  geom_boxplot()+
  labs(title="Log10 Mass range by class")
```
...
homerange %>% 
  ...
  geom_boxplot()+
  labs(title="Log10 Mass range by Taxon")
```
...
deserts2 %>% 
  ...
  geom_line()+
  geom_point(shape=5)+ #point addition, number = type of shape
...
homerange %>% 
  ...
  geom_histogram(alpha = 0.4, color = "black", fill = "deepskyblue4", bins=40)+ # color - outline
...
homerange %>% 
  ...
  geom_histogram(color="black",fill="lavenderblush")+
...
homerange %>% 
  ggplot(aes(x=log10.hra))+
  geom_density(color="black",fill="lavenderblush")+
  labs(title = "Distribution of Homerange")
```
...
homerange %>% 
  ggplot(aes(x=log10.hra))+
  geom_histogram(aes(y=..density..), color="black",fill="lavenderblush")+
...
homerange %>% 
  ...
  geom_bar(position = "dodge")+
  labs(title = "Distribution of Taxonomic Classes and Range Category", x = "Range Category", y = "N")
```
...
homerange %>% 
  ...
  ggplot(aes(x=class, y=log10.mass))+
  geom_boxplot()+
  labs(title = "Range of log10 mass for small animals by taxonomic class", x = "Class", y = "Log10 mass")
```
